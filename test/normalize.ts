...
runTest("let milliseconds bubble up", () => {
...
runTest("remove months and let days bubble up", () => {
  const duration = new Duration()
    .setMonths(5)
    .setDays(500)
    .unsafeNormalize()
